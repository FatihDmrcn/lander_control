...
class QDrawWidget(Qtw.QWidget):
    ...
    def draw_thrust(self):
        if self.forces is not None:
            ...
            b = Qtc.QPointF(-self.forces[0], self.l/2+0.1*self.forces[2])
